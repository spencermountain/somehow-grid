...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "box svelte-142d833");
    			set_style(div, "background-color", /*c*/ ctx[6]);
    			add_location(div, file, 50, 4, 1085);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "container row svelte-142d833");
    			set_style(div, "width", "100%");
    			add_location(div, file, 48, 0, 1010);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, parts, $$value => $$invalidate(2, $parts = $$value));
    	let { total = 100 } = $$props;
    	let squares = [];
    	...
    	return [squares, total, $parts, calculate, $$scope, $$slots];
    }

    class Grid extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { total: 1 });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			add_location(div, file$1, 19, 0, 312);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	parts.update(arr => {
    		arr.push({ color: colors[color] || color, count });
    		return arr;
    	});
    	...
    	$$self.$capture_state = () => ({ c: spencerColor, parts, color, count, colors });
