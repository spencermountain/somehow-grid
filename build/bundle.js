    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 84, 6, 1743);
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 89, 6, 1927);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 82, 2, 1692);
    			attr_dev(div1, "class", "squares svelte-phf26h");
    			add_location(div1, file, 87, 2, 1874);
    			attr_dev(div2, "class", "container svelte-phf26h");
    			set_style(div2, "width", "100%");
    			add_location(div2, file, 81, 0, 1646);
    		},
